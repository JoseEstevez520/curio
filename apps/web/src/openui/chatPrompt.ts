...
const CHAT_TASK_NOTE = [
  ...
  'CodeBlock, KeyStat, Callout) whenever they express the answer better than prose. Match the piece',
  'to the shape: Steps for how-tos, Comparison for X-vs-Y, CodeBlock for code, Timeline for dates.',
  'CRITICAL: the root MUST wrap ALL pieces in ONE array —',
