 ...
 * rather than a spinner. Monochrome bars with a gentle shimmer — no color, no shadow, and
 * the shimmer stops entirely under prefers-reduced-motion (see index.css).
 */
